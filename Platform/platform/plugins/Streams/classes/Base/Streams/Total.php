 ...
 * Instead, change the Streams_Total.php file.
 *
 * @module Streams
 */
/**
...
abstract class Base_Streams_Total extends Db_Row
{
	...
	{
		if (Q_Config::get('Db', 'connections', 'Streams', 'indexes', 'Total', false)) {
	...
	static function insertManyAndExecute($rows = array(), $options = array())
	{
		self::db()->insertManyAndExecute(
			self::table(), $rows,
			array_merge($options, array('className' => 'Streams_Total'))
		);
	}
...
return array (
  ...
  3 => NULL,
	...
	function beforeSet_messageType($value)
	{
		...
		if (strlen($value) > 255)
			throw new Exception('Exceedingly long value being assigned to '.$this->getTable().".messageType");
		return array('messageType', $value);			
	}
...
return array (
  ...
  3 => NULL,
	...
	function beforeSet_messageCount($value)
	{
		...
		$value = intval($value);
		if ($value < -9.2233720368548E+18 or $value > 9.2233720368548E+18) {
...
return array (
  ...
  3 => '0',
	...
	function beforeSave($value)
	{
		if (!$this->retrieved) {
			$table = $this->getTable();
			foreach (array('publisherId','streamName','messageType') as $name) {
				if (!isset($value[$name])) {
	...
	{
		$field_names = array('publisherId', 'streamName', 'messageType', 'messageCount');
		$result = $field_names;
